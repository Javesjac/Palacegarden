 ...
 * Replicated from: https://myvisionagency.github.io/Palacegarden/
 * 
 * @package HelloBiz
 */
?>
...
<style>
    ...
    /* Dropdown Content - Matches Reference's hidden structure if active */
    ...
    /* Quick Links, Contact, Legal - Clean Text Style (No Icons) */
    .quick-links,
    .contact-list,
    .legal-links {
        list-style: none;
        ...
        <div class="footer-main-grid">
            ...
            <div class="footer-col footer-logo-section">
                ...
                <div class="footer-btn-row">
                    ...
                    <a href="<?php echo home_url('/contact/'); ?>" class="footer-btn">
                        <svg viewBox="0 0 24 24">
                            <path
            ...
            <!-- Column 3: Quick Links - No Icons in Reference -->
            <div class="footer-col">
                <div class="footer-col-header">
                    <svg viewBox="0 0 24 24">
                        <path
                ...
                <ul class="quick-links">
                    ...
                    <li><a href="<?php echo home_url('/producten/'); ?>">Produkte</a></li>
                    <li><a href="<?php echo home_url('/terrassenueberdachungen/'); ?>">Terrassenüberdachungen</a></li>
                    <li><a href="<?php echo home_url('/sonnenschutz/'); ?>">Sonnenschutz</a></li>
                    <li><a href="<?php echo home_url('/schiebeanlagen/'); ?>">Schiebeanlagen</a></li>
                    <li><a href="<?php echo home_url('/seitenwaende/'); ?>">Seitenwände</a></li>
                    <li><a href="<?php echo home_url('/galerie/'); ?>">Galerie</a></li>
                    <li><a href="<?php echo home_url('/about/'); ?>">Über uns</a></li>
                    <li><a href="<?php echo home_url('/contact/'); ?>">Kontakt</a></li>
                </ul>
            </div>

            <!-- Column 4: Contact & Legal - No Icons in Reference -->
            <div class="footer-col">
                <div class="footer-col-header">
                    <svg viewBox="0 0 24 24">
                        <path
                ...
                <ul class="contact-list">
                    <li><a href="tel:+31548514245"><span>+31 548 514245</span></a></li>
                    <li><a href="mailto:info@palacegarden.nl"><span>info@palacegarden.nl</span></a></li>
                    <li><a href="https://www.google.com/maps/search/?api=1&query=Neonstraat+5C+Rijssen"
                            target="_blank"><span>Neonstraat 5C<br>7463 PE Rijssen</span></a></li>
                </ul>
...
<script>
    ...
    (function () {
        ...
        const schedule = {
            1: { open: 540, close: 1140 }, // Monday
            2: { open: 540, close: 1140 }, // Tuesday
            3: { open: 540, close: 1140 }, // Wednesday
            4: { open: 540, close: 1140 }, // Thursday
            5: { open: 540, close: 1140 }, // Friday
            6: { open: 540, close: 1020 }, // Saturday
        ...
        if (statusDot && statusText) {
            ...
            statusText.textContent = isOpen ? 'Geöffnet' : 'Geschlossen';
        }
