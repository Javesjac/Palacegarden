<?php
/**
 * Palace Garden Custom Footer (Restored My Vision Design)
 * 
 * @package HelloBiz
 */
?>
        ...
        <div class="footer-main-grid">
            ...
            <div class="footer-col">
                ...
                <ul class="quick-links">
                    ...
                    <li>
                        <a href="<?php echo home_url('/producten/'); ?>">
                            <svg viewBox="0 0 24 24">
                                <path
                    ...
                    <li>
                        <a href="<?php echo home_url('/galerie/'); ?>">
                            <svg viewBox="0 0 24 24">
                                <path
            ...
            <div class="footer-col">
                ...
                <ul class="legal-links">
                    ...
                    <li>
                        <a href="<?php echo home_url('/datenschutz/'); ?>">
                            <svg viewBox="0 0 24 24">
                                <path
